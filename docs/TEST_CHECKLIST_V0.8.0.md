...
## Installation
- [ ] Exécuter `sql/HOTFIX_V0.8.0_EXISTING_DB.sql` sans erreur.
- [ ] Redéployer `sync-football-data`.
- [ ] Vérifier `APP_VERSION = 0.8.0` et cache PWA V0.8.0.
...
- [ ] Admin > Compétition > **Centre C1** synchronise la saison 2026/27.
- [ ] Une saison 2025/26 renvoyée par le fournisseur est refusée.
- [ ] Le classement affiche les zones 1–8 / 9–24 / 25–36.
- [ ] Cliquer sur le PSG (ou tout autre club) ouvre sa fiche.
- [ ] La fiche affiche classement, points, V-N-D, différence, forme, 5 derniers et 5 prochains matchs.
- [ ] Les résultats réels n'altèrent pas directement le barème de pronostics.
