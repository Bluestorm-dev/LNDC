...
// Le Nid des Champions V0.9.13 — orchestration et démarrage
  async function boot() {
    bindStaticEvents();
    ...
    if (demoMode) {
      ...
      $("#demoBanner").innerHTML = "🛠️ <b>V0.9.13 en mode démo :</b> phase de ligue, champions, phases finales et LIVE sont simulés localement quand les données sont disponibles.";
      demoInit();
