...
// Le Nid des Champions V1.0.0 — orchestration et démarrage
  async function boot() {
    bindStaticEvents();
    ...
    if (demoMode) {
      ...
      $("#demoBanner").innerHTML = "🛠️ <b>V1.0.0 en mode démo :</b> phase de ligue, champions, phases finales et LIVE sont simulés localement quand les données sont disponibles.";
      demoInit();
