...
// Le Nid des Champions V1.0.2 — orchestration et démarrage
  async function boot() {
    bindStaticEvents();
    ...
    if (demoMode) {
      ...
      $("#demoBanner").innerHTML = "🛠️ <b>V1.0.2 en mode démo :</b> phase de ligue, champions, phases finales et LIVE sont simulés localement quand les données sont disponibles.";
      demoInit();
  ...
  function bindStaticEvents() {
    ...
    if($("#createMatchdayBtn")) $("#createMatchdayBtn").onclick = createMatchday;
    if($("#createMatchBtn")) $("#createMatchBtn").onclick = createMatch;
    ...
    if($("#adminMdNumber") && $("#adminMdName")) $("#adminMdNumber").oninput = () => { const n=Number($("#adminMdNumber").value||1); $("#adminMdName").value=`Journée ${n}`; };
