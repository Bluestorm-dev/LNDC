  ...
  function openClubEditorV0910(clubId=null){
    ...
    $("#saveClubV0910",root).onclick=async()=>{
      try{
        ...
        root.remove();await loadData();renderAll();await refreshCalendarHealthV0910();toast(club?"Équipe modifiée.":"Équipe ajoutée.");
