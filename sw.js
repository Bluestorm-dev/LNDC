const CACHE = "nid-champions-v0.9.9";
const CORE = [
  "./","./index.html","./manifest.webmanifest","./config.js",
  "./css/base.css","./css/predictions.css","./css/ranking.css","./css/clubs.css","./css/champions.css","./css/layout.css","./css/teams.css","./css/avatars.css","./css/communication.css","./css/social.css","./css/admin.css","./css/gamification.css","./css/ucl.css","./css/evenings.css","./css/v080.css","./css/career.css","./css/admin095.css","./css/finale098.css","./css/final-report098.css","./css/preseason099.css",
  "./js/core.js","./js/avatars.js","./js/teams.js","./js/notifications.js","./js/social.js","./js/rivals.js","./js/support.js","./js/owl.js","./js/auth.js","./js/data.js","./js/champions.js","./js/ucl.js","./js/evenings.js","./js/profile.js","./js/career.js","./js/predictions.js","./js/ranking.js","./js/admin.js","./js/admin-test.js","./js/admin095.js","./js/finale098.js","./js/preseason099.js","./js/realtime.js","./js/gamification.js","./js/app.js",
  "./finale.html","./diplome.html","./js/final-report098.js","./assets/assets-manifest.json","./assets/avatars/avatar-catalog.json","./assets/icons/icon-192.png","./assets/icons/icon-512.png","./assets/branding/owl/owl-masked-main.png","./assets/avatars/nid/avatar-hibou-or.png"
];
